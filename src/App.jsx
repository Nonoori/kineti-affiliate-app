        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              <button className="px-4 py-2 text-sm font-semibold rounded-lg border border-slate-700 bg-slate-900/60 hover:bg-slate-800 transition">
                Log in
              </button>
              <button className="px-5 py-2 text-sm font-semibold rounded-lg bg-emerald-500 hover:bg-emerald-400 text-slate-950 transition">
                Sign up
              </button>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-b border-slate-800 bg-[#0c121e] px-4 pt-2 pb-6 space-y-3">
            ...
            <div className="pt-4 flex flex-col gap-2">
              <button className="w-full py-2.5 rounded-lg border border-slate-700 font-semibold text-white bg-slate-800/40">Log in</button>
              <button className="w-full py-2.5 rounded-lg font-semibold bg-emerald-500 text-slate-950">Sign up</button>
            </div>
          </div>
        )}
      </nav>
      ...
      <section id="training" className="py-16 px-4 max-w-4xl mx-auto border-t border-slate-800/60">
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-b from-[#0f172a] to-[#0a0f1c] border border-emerald-500/20">
          ...
          <div className="pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button className="w-full sm:w-auto px-8 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold transition">
              Enroll &amp; Start Today
            </button>
          </div>
        </div>
